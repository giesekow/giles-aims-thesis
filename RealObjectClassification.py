...
from load_real_world import get_training_data,get_test_data
import time
...
if __name__ == '__main__':
    ...
    d_train_set_x,d_valid_set_x,d_train_set_y,d_valid_set_y = train_test_split(X,Y,train_size=0.8,random_state=rng)    
    d_test_set_x,d_test_set_y = get_test_data()  
    ...
    np.save("r_obj_pred/test_set_labels.npy",d_test_set_y)
    ...
    np.save("r_obj_pred/normal_knn.npy",norm_knn_pred)  
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/normal_logistic.npy",norm_logistic_pred)  
    eval_times.append(end_time-start_time)
    ...
    np.save("r_obj_pred/exec_times_norm.npy",eval_times)
    ...
    end_time =time.clock()
    np.save("r_obj_pred/pca_knn.npy",pca_knn_pred)
    eval_times.append(end_time-start_time)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/pca_logistic.npy",pca_logistic_pred)
    eval_times.append(end_time-start_time)
    
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_pca.npy",eval_times)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/rbm_knn.npy",rbm_knn_pred)
    eval_times.append(end_time-start_time)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/rbm_logistic.npy",rbm_logistic_pred)
    eval_times.append(end_time-start_time)
    
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_rbm.npy",eval_times)
    ...
    end_time = time.clock()   
    np.save("r_obj_pred/maxp_knn.npy",maxp_knn_pred)
    eval_times.append(end_time-start_time)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/maxp_logistic.npy",maxp_logistic_pred)
    eval_times.append(end_time-start_time)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/maxp_dbn.npy",maxp_dbn_pred)
    eval_times.append(end_time-start_time)
    
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_maxp.npy",eval_times)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/normal_perceptron.npy",norm_perceptron_pred)    
    eval_times.append(end_time-start_time)
    ...
    end_time = time.clock()    
    np.save("r_obj_pred/maxp_perceptron.npy",maxp_perceptron_pred)
    eval_times.append(end_time-start_time)
    
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_mlp.npy",eval_times)
    ...
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_conv_mlp.npy",eval_times)
    ...
    eval_times = np.array(eval_times)
    np.save("r_obj_pred/exec_times_t_dbn.npy",eval_times)